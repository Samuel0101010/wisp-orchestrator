...
function managerPrompt(): string {
  return [
    ...
    '<<ACTION>>',
    '{"kind":"create_project","name":"InvoiceLite","goal":"A minimal CLI invoice generator in TypeScript","repoPath":"C:/Users/samue/code/invoice-lite","team":["backend-dev","qa-engineer"]}',
    '<<END>>',
    '',
