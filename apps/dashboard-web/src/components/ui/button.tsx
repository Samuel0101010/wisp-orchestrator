...
const BUTTON_TRANSITION: React.CSSProperties = {
  transition:
    'background-color var(--duration-quick) var(--ease-smooth), color var(--duration-quick) var(--ease-smooth), box-shadow var(--duration-base) var(--ease-smooth)',
};
