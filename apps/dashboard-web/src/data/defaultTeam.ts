...
export const DEVELOPER_DEFAULT: AgentSpec = {
  role: 'developer',
  model: 'sonnet',
  allowedTools: ['Read', 'Edit', 'Write', 'MultiEdit', 'Bash(npm:*, pnpm:*, git:*)'],
...
export const QA_DEFAULT: AgentSpec = {
  role: 'qa',
  model: 'sonnet',
  allowedTools: ['Read', 'Bash(pnpm test:*, pnpm build:*, pnpm lint:*)'],
