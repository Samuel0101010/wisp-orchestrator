// v1.7.0 FINAL screenshot script (post Wave A/B/C). EN-only, both themes, 12 routes.
// Run from repo root: node audit-artifacts/scripts/screenshot-v170-final.mjs
...
async function captureOne(browser, route, slugName, theme) {
  ...
  const file = resolve(OUT_DIR, `v1.7.0-final-${slugName}-${theme}.png`);
  let status = 'ok';
  try {
