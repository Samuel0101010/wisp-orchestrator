...
<p align="center">
  <a href="https://github.com/Samuel0101010/wisp-orchestrator/releases/download/v2.1.0/wisp-promo.mp4">
    <img src="docs/assets/promo-poster.png" alt="Watch the WISP promo — a 2-minute tour: a team of Claude agents builds, previews, and iterates on a real app, live" width="100%">
  </a>
</p>

<p align="center"><sub><i>▶ <b>Watch the 2-minute tour</b> — a team of Claude agents builds, previews, and iterates on a real app, live. <a href="https://github.com/Samuel0101010/wisp-orchestrator/releases/download/v2.1.0/wisp-promo.mp4">Play / download →</a></i></sub></p>
